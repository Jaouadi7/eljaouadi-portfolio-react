        ...
        <nav className="navbar is-transparent" role="navigation" aria-label="main navigation">
            ...
            <div className="navbar-brand">
                ...
                <a href="https://eljaouadi.online" className="navbar-item">
                    ...
                    <img src={logo} alt="Eljaouadi Freelancer Full stack developer Website e-commerce woocommerce design and development" />
                ...
                <div className="dropdown is-flex-touch is-hidden-desktop is-right languages-dorpdown ml-auto" >
                    ...
                    <div className="dropdown-menu" id="dropdown-menu" role="menu" >
                        ...
                        <div className="dropdown-content">
                            ...
                            {LANGUAGES.map((language, index) => <div className={`dropdown-item ${language.code}-button `} data-lang={language.code} key={index} onClick={() => i18n.changeLanguage(language.code)}>{language.label}</div>)}
            ...
            <div className="navbar-menu">
                ...
                <div className="navbar-end">
                    ...
                    {
                        pages.map((page, index) => <NavLink to={page === 'home' ? '/' : page} key={index} className="navbar-item is-uppercase">{t(`navbar.${page}`)}</NavLink>)
                    }
