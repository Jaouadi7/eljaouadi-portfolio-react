                        ...
                        <div className="column is-8">
                            ...
                            <div className="sections-container">
                                ...
                                <Routes>
                                    ...
                                    <Route path="/skills" element={<Skills setActivePage={setActivePage} />} />
                                    <Route path="/portfolio" element={<Portfolio setActivePage={setActivePage} />} />
                                    <Route path="/offers" element={<Offers setActivePage={setActivePage} />} />
                                    <Route path="/reviews" element={<Reviews setActivePage={setActivePage} />} />
